    ...
    public class TSqlStandardParser : ISqlTokenParser {
        ...
        */
        ...
        private static void InitializeKeywordList() {
            ...
            KeywordList.Add("CONNECTIONPROPERTY", KeywordType.FunctionKeyword);
            KeywordList.Add("CONTEXT_INFO", KeywordType.FunctionKeyword);
            KeywordList.Add("CURRENT_REQUEST_ID", KeywordType.FunctionKeyword);
            KeywordList.Add("CURRENT_TRANSACTION_ID", KeywordType.FunctionKeyword);
            KeywordList.Add("DECOMPRESS", KeywordType.FunctionKeyword);
            KeywordList.Add("ERROR_LINE", KeywordType.FunctionKeyword);
            KeywordList.Add("ERROR_MESSAGE", KeywordType.FunctionKeyword);
            ...
            //KeywordList.Add("ISNULL", KeywordType.FunctionKeyword);
            //KeywordList.Add("ISNUMERIC", KeywordType.FunctionKeyword);
            KeywordList.Add("MIN_ACTIVE_ROWVERSION", KeywordType.FunctionKeyword);
            //KeywordList.Add("NEWID", KeywordType.FunctionKeyword);
            KeywordList.Add("NEWSEQUENTIALID", KeywordType.FunctionKeyword);
            KeywordList.Add("ROWCOUNT_BIG", KeywordType.FunctionKeyword);
            KeywordList.Add("SESSION_CONTEXT", KeywordType.FunctionKeyword);
            KeywordList.Add("XACT_STATE", KeywordType.FunctionKeyword);
        }
